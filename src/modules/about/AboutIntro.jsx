  ...
  <StyledAboutIntro>
    <AboutCard>
      <h2 ref={TitleAnim}>
        ...
        <h6>My creative career began at the world's first interactive agency in Los Angeles, where we launched the first websites for Adidas, Lexus, Wide World of Disney, and the Smithsonian-Award winning, <cite>'StarBright'</cite>. I then moved to San Francisco where I worked in Cupertino, for U.S.Web/CKS for 2 years designing websites rich in animation, interactivity and multimedia &#8212; delivering the original launch sites for Levi's, Docker's, Williams-Sonoma, and JCPenney.</h6>
